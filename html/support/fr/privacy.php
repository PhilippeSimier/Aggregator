...
<body>
	...
	<div class="container" >
		<div style="min-height : 500px">	
			<h4>An overview of data protection</h4>
			<h5>General</h5>
			...
			Detailed information on the subject of data protection can be found in our privacy policy found below.</p>
			<h5>Data collection on our website</h5>
			<p>Who is responsible for the data collection on this website?</br>
				The data collected on this website are processed by the website operator. The operator's contact details can be found in the website's required legal notice.

			<p>How do we collect your data?</br>
			Some data are collected when you provide it to us. This could, for example, be data you enter on a contact form.</p>
			<p>Other data are collected automatically by our IT systems when you visit the website. 
			...
			<p>You always have the right to request information about your stored data, its origin, its recipients, and the purpose of its collection at no charge. 
			   ...
			   You may also, of course, file a complaint with the competent regulatory authorities.</p>
			
			<h4>Data protection</h4>
            <p>The operators of this website take the protection of your personal data very seriously. 
			...
			<p>Notice concerning the party responsible for this website
			The party responsible for processing data on this website is:</br>

			Section SNIR</br>
			LPO Touchard Washington</br>
			Place Washington</br>
			72000 Le Mans</br>
			France</br>
			</br>
			Telephone: +33243501620</br>
			Email: </br>
			
			<p>The responsible party is the natural or legal person who alone or jointly 
			with others decides on the purposes and means of processing personal data (names, email addresses, etc.).
			</p>
		</div>
		<?php 
