...
-- Généré le :  Dim 14 Mars 2021 à 22:05
...
(752841, 10, 'Derived  Weight ', '', 'derived weight (Kg/h)', '', '', '', '', '', '', '', '', 'AVKOTCZ049Z420QC', '2021-03-09 20:03:18', 3, 1, NULL, NULL),
...
(1, 2, 'Ecrire la date dans le fichier datelog.txt', 'echo \"Tâche planifiée exécutée le `date`\" >> /home/pi/datelog.txt 2>&1', 'shell', '2021-02-25 23:00:00', '2021-03-14 15:00:01', 0),
...
(5, 8, 'test classe channel', '#Insert your code here\r\nuse Aggregator\\Support\\Channel;\r\n\r\n	$mesuresMuguet = new Channel( $bdd, 752843);\r\n	$derivedMuguet = new Channel( $bdd, 752841);\r\n    print_r($mesuresMuguet->read(\"field1\",10));\r\n    print_r($mesuresMuguet->avg(\"field1\",10));\r\n    \r\n    #$derivedMuguet->write(\"field1\", 41.2);\r\n	print_r($derivedMuguet->read(\"field1\",10));', 'php', '2021-03-06 16:35:24', NULL, NULL),
(6, 2, 'Mesures', '#Insert your code here\r\nls -la', 'shell', '2021-03-13 11:17:01', NULL, NULL),
...
(0, 'root', '5cd8817d8fdb26fb7dd1d433500b50db51b8e925a2709de97a89abb6b41906a9', 'M06K292ANH0Z5DA0G603', 'philaure@wanadoo.fr', '0689744235', 'RDIK9LVVYEYZYZER', '2019-08-11 10:42:44', 677, '2021-03-14 13:46:53', '2021-03-14 15:04:21', 'Europe/Paris', 140, 15, 1, 2, NULL, 'FR', 1),
